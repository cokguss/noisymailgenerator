(() => {
  ...
  const DICT = {
    en: {
      ...
      "pub.h2": "Live stats",
      "pub.sub": "Real usage numbers, out in the open. Aggregate only — every visitor stays anonymous.",
      "pub.operational": "all systems operational",
      "pub.total": "total visits",
      "pub.today": "visits today",
      "pub.uniq": "visitors today",
      "pub.days": "days online",
      "pub.note": "// no cookies · no profiles · IPs hashed daily",
    ...
    id: {
      ...
      "pub.h2": "Statistik langsung",
      "pub.sub": "Angka pemakaian nyata, terbuka untuk semua. Hanya agregat — setiap pengunjung tetap anonim.",
      "pub.operational": "semua sistem berjalan normal",
      "pub.total": "kunjungan total",
      "pub.today": "kunjungan hari ini",
      "pub.uniq": "pengunjung hari ini",
      "pub.days": "hari online",
      "pub.note": "// tanpa cookie · tanpa profil · IP di-hash harian",
